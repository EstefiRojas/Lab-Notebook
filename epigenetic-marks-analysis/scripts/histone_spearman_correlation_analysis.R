...
df <- data.frame(sequence_type = c("lncRNA Exons","Short ncRNAs","Protein-coding Exons"),
                 correlation = c(correlation_list[[lncrna_file1]][1,3], correlation_list[[sncrna_file1]][1,3], correlation_list[[protein_file1]][1,3],
                                 correlation_list[[lncrna_file2]][1,3], correlation_list[[sncrna_file2]][1,3], correlation_list[[protein_file2]][1,3],
                                 correlation_list[[lncrna_file3]][1,3], correlation_list[[sncrna_file3]][1,3], correlation_list[[protein_file3]][1,3],
                                 correlation_list[[lncrna_file4]][1,3], correlation_list[[sncrna_file4]][1,3], correlation_list[[protein_file4]][1,3],
                                 correlation_list[[lncrna_file5]][1,3], correlation_list[[sncrna_file5]][1,3], correlation_list[[protein_file5]][1,3],
                                 correlation_list[[lncrna_file6]][1,3], correlation_list[[sncrna_file6]][1,3], correlation_list[[protein_file6]][1,3],
                                 correlation_list[[lncrna_file7]][1,3], correlation_list[[sncrna_file7]][1,3], correlation_list[[protein_file7]][1,3],
                                 correlation_list[[lncrna_file8]][1,3], correlation_list[[sncrna_file8]][1,3], correlation_list[[protein_file8]][1,3]
                                 ),
                 lower_ci = c(correlation_list[[lncrna_file1]][2,3], correlation_list[[sncrna_file1]][2,3], correlation_list[[protein_file1]][2,3],
                              correlation_list[[lncrna_file2]][2,3], correlation_list[[sncrna_file2]][2,3], correlation_list[[protein_file2]][2,3],
                              correlation_list[[lncrna_file3]][2,3], correlation_list[[sncrna_file3]][2,3], correlation_list[[protein_file3]][2,3],
                              correlation_list[[lncrna_file4]][2,3], correlation_list[[sncrna_file4]][2,3], correlation_list[[protein_file4]][2,3],
                              correlation_list[[lncrna_file5]][2,3], correlation_list[[sncrna_file5]][2,3], correlation_list[[protein_file5]][2,3],
                              correlation_list[[lncrna_file6]][2,3], correlation_list[[sncrna_file6]][2,3], correlation_list[[protein_file6]][2,3],
                              correlation_list[[lncrna_file7]][2,3], correlation_list[[sncrna_file7]][2,3], correlation_list[[protein_file7]][2,3],
                              correlation_list[[lncrna_file8]][2,3], correlation_list[[sncrna_file8]][2,3], correlation_list[[protein_file8]][2,3]
                              ),
                 upper_ci = c(correlation_list[[lncrna_file1]][3,3], correlation_list[[sncrna_file1]][3,3], correlation_list[[protein_file1]][3,3],
                              correlation_list[[lncrna_file2]][3,3], correlation_list[[sncrna_file2]][3,3], correlation_list[[protein_file2]][3,3],
                              correlation_list[[lncrna_file3]][3,3], correlation_list[[sncrna_file3]][3,3], correlation_list[[protein_file3]][3,3],
                              correlation_list[[lncrna_file4]][3,3], correlation_list[[sncrna_file4]][3,3], correlation_list[[protein_file4]][3,3],
                              correlation_list[[lncrna_file5]][3,3], correlation_list[[sncrna_file5]][3,3], correlation_list[[protein_file5]][3,3],
                              correlation_list[[lncrna_file6]][3,3], correlation_list[[sncrna_file6]][3,3], correlation_list[[protein_file6]][3,3],
                              correlation_list[[lncrna_file7]][3,3], correlation_list[[sncrna_file7]][3,3], correlation_list[[protein_file7]][3,3],
                              correlation_list[[lncrna_file8]][3,3], correlation_list[[sncrna_file8]][3,3], correlation_list[[protein_file8]][3,3]),
