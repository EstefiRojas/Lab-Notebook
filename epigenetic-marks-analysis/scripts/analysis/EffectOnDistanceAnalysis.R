...
funcProtExon2Data <- data.frame(Dataset = "protein-coding-exon2", read.csv("../data/latest1000all/functional-protein-exon2-dataset-features.csv", header=TRUE))
funcProtExon3Data <- data.frame(Dataset = "protein-coding-exon3", read.csv("../data/latest1000all/functional-protein-exon3-dataset-features.csv", header=TRUE))
funcLncrnaExon1Data <- data.frame(Dataset = "lncrna-exon1", read.csv("../data/latest1000all/functional-lncrna-exon1-dataset-features.csv", header=TRUE))
funcLncrnaExon2Data <- data.frame(Dataset = "lncrna-exon2", read.csv("../data/latest1000all/functional-lncrna-exon2-dataset-features.csv", header=TRUE))
funcSncrnaDataset <- data.frame(Dataset = "short-ncrna", read.csv("../data/latest1000all/functional-short-ncrna-dataset-features.csv", header=TRUE))

protExon2NCData <- data.frame(Dataset = "protein-exon2-negative-control",read.csv("../data/latest1000all/protein-exon2-negative-control-dataset-features.csv", header=TRUE))
protExon3NCData <- data.frame(Dataset = "protein-exon3-negative-control",read.csv("../data/latest1000all/protein-exon3-negative-control-dataset-features.csv", header=TRUE))
lncrnaExon1NCData <- data.frame(Dataset = "lncrna-exon1-negative-control",read.csv("../data/latest1000all/lncrna-exon1-negative-control-dataset-features.csv", header=TRUE))
lncrnaExon2NCData <- data.frame(Dataset = "lncrna-exon2-negative-control",read.csv("../data/latest1000all/lncrna-exon2-negative-control-dataset-features.csv", header=TRUE))
sncrnaNCData <- data.frame(Dataset = "short-ncrna-negative-control",read.csv("../data/latest1000all/short-ncrna-negative-control-dataset-features.csv", header=TRUE))
...
# Generate violin plots for all selected features
...
############
#Protein coding
prot_corr_matrix <- list()
1:length(prot_delta_zscores_bin1$SNP_density)
prot_corr_matrix$bin1.2w <- weightedCorr(prot_delta_zscores_bin1$SNP_density,prot_delta_zscores_bin2$SNP_density[1:1412], method = "spearman", weights = 1:length(prot_delta_zscores_bin1$SNP_density))
prot_corr_matrix$bin1.2 <- cor.test(prot_delta_zscores_bin1$SNP_density,prot_delta_zscores_bin2$SNP_density[1:1412], method = "spearman")
prot_corr_matrix$bin1.3 <- cor.test(prot_delta_zscores_bin1$SNP_density,prot_delta_zscores_bin3$SNP_density[1:1412], method = "spearman")
prot_corr_matrix$bin1.4 <- cor.test(prot_delta_zscores_bin1$SNP_density,prot_delta_zscores_bin4$SNP_density[1:1412], method = "spearman")
prot_corr_matrix$bin2.3 <- cor.test(prot_delta_zscores_bin2$SNP_density,prot_delta_zscores_bin3$SNP_density[1:2700], method = "spearman")
prot_corr_matrix$bin2.4 <- cor.test(prot_delta_zscores_bin2$SNP_density,prot_delta_zscores_bin4$SNP_density[1:2700], method = "spearman")
prot_corr_matrix$bin3.4 <- cor.test(prot_delta_zscores_bin3$SNP_density,prot_delta_zscores_bin4$SNP_density[1:4631], method = "spearman")


prot_corr_df <- data.frame(
  estimate = rbind(prot_corr_matrix$bin1.2$estimate,
                   prot_corr_matrix$bin1.3$estimate,
                   prot_corr_matrix$bin1.4$estimate,
                   prot_corr_matrix$bin2.3$estimate,
                   prot_corr_matrix$bin2.4$estimate,
                   prot_corr_matrix$bin3.4$estimate),  # Placeholder values for 'estimate'
  p.value = rbind(prot_corr_matrix$bin1.2$p.value,
                  prot_corr_matrix$bin1.3$p.value,
                  prot_corr_matrix$bin1.4$p.value,
                  prot_corr_matrix$bin2.3$p.value,
                  prot_corr_matrix$bin2.4$p.value,
                  prot_corr_matrix$bin3.4$p.value),    # Placeholder values for 'p.value'
  row.names = c("(1-5k)-(5k-50k)","(1-5k)-(50k-500k)","(1-5k)-(500k-5M)",
                "(5k-50k)-(50k-500k)","(5k-50k)-(500k-5M)","(50k-500k)-(500k-5M)")
)
prot_corr_df

#lncRNA
lncrna_corr_matrix <- list()

lncrna_corr_matrix$bin1.2 <- cor.test(lncrna_delta_zscores_bin1$SNP_density,lncrna_delta_zscores_bin2$SNP_density[1:230], method = "spearman")
lncrna_corr_matrix$bin1.3 <- cor.test(lncrna_delta_zscores_bin1$SNP_density,lncrna_delta_zscores_bin3$SNP_density[1:230], method = "spearman")
lncrna_corr_matrix$bin1.4 <- cor.test(lncrna_delta_zscores_bin1$SNP_density,lncrna_delta_zscores_bin4$SNP_density[1:230], method = "spearman")
lncrna_corr_matrix$bin2.3 <- cor.test(lncrna_delta_zscores_bin2$SNP_density,lncrna_delta_zscores_bin3$SNP_density[1:1033], method = "spearman")
lncrna_corr_matrix$bin2.4 <- cor.test(lncrna_delta_zscores_bin2$SNP_density,lncrna_delta_zscores_bin4$SNP_density[1:1033], method = "spearman")
lncrna_corr_matrix$bin3.4 <- cor.test(lncrna_delta_zscores_bin3$SNP_density,lncrna_delta_zscores_bin4$SNP_density[1:2441], method = "spearman")


lncrna_corr_df <- data.frame(
  estimate = rbind(lncrna_corr_matrix$bin1.2$estimate,
                   lncrna_corr_matrix$bin1.3$estimate,
                   lncrna_corr_matrix$bin1.4$estimate,
                   lncrna_corr_matrix$bin2.3$estimate,
                   lncrna_corr_matrix$bin2.4$estimate,
                   lncrna_corr_matrix$bin3.4$estimate),  # Placeholder values for 'estimate'
  p.value = rbind(lncrna_corr_matrix$bin1.2$p.value,
                  lncrna_corr_matrix$bin1.3$p.value,
                  lncrna_corr_matrix$bin1.4$p.value,
                  lncrna_corr_matrix$bin2.3$p.value,
                  lncrna_corr_matrix$bin2.4$p.value,
                  lncrna_corr_matrix$bin3.4$p.value),    # Placeholder values for 'p.value'
  row.names = c("(1-5k)-(5k-50k)","(1-5k)-(50k-500k)","(1-5k)-(500k-5M)",
                "(5k-50k)-(50k-500k)","(5k-50k)-(500k-5M)","(50k-500k)-(500k-5M)")
)
lncrna_corr_df
...
#sncRNA
sncrna_corr_matrix <- list()

sncrna_corr_matrix$bin1.2 <- cor.test(sncrna_delta_zscores_bin1$SNP_density,sncrna_delta_zscores_bin2$SNP_density[1:505], method = "spearman")
sncrna_corr_matrix$bin1.3 <- cor.test(sncrna_delta_zscores_bin1$SNP_density,sncrna_delta_zscores_bin3$SNP_density[1:505], method = "spearman")
sncrna_corr_matrix$bin1.4 <- cor.test(sncrna_delta_zscores_bin1$SNP_density,sncrna_delta_zscores_bin4$SNP_density[1:505], method = "spearman")
sncrna_corr_matrix$bin2.3 <- cor.test(sncrna_delta_zscores_bin2$SNP_density,sncrna_delta_zscores_bin3$SNP_density[1:2044], method = "spearman")
sncrna_corr_matrix$bin2.4 <- cor.test(sncrna_delta_zscores_bin2$SNP_density,sncrna_delta_zscores_bin4$SNP_density[1:2044], method = "spearman")
sncrna_corr_matrix$bin3.4 <- cor.test(sncrna_delta_zscores_bin3$SNP_density,sncrna_delta_zscores_bin4$SNP_density[1:4592], method = "spearman")


sncrna_corr_df <- data.frame(
  estimate = rbind(sncrna_corr_matrix$bin1.2$estimate,
                   sncrna_corr_matrix$bin1.3$estimate,
                   sncrna_corr_matrix$bin1.4$estimate,
                   sncrna_corr_matrix$bin2.3$estimate,
                   sncrna_corr_matrix$bin2.4$estimate,
                   sncrna_corr_matrix$bin3.4$estimate),  # Placeholder values for 'estimate'
  p.value = rbind(sncrna_corr_matrix$bin1.2$p.value,
                  sncrna_corr_matrix$bin1.3$p.value,
                  sncrna_corr_matrix$bin1.4$p.value,
                  sncrna_corr_matrix$bin2.3$p.value,
                  sncrna_corr_matrix$bin2.4$p.value,
                  sncrna_corr_matrix$bin3.4$p.value),    # Placeholder values for 'p.value'
  row.names = c("(1-5k)-(5k-50k)","(1-5k)-(50k-500k)","(1-5k)-(500k-5M)",
                "(5k-50k)-(50k-500k)","(5k-50k)-(500k-5M)","(50k-500k)-(500k-5M)")
)
sncrna_corr_df
...
prot_corr_matrix$bin1.2 <- cor.test(prot_delta_zscores_bin1$MAF_avg,prot_delta_zscores_bin2$MAF_avg[1:1412], method = "spearman")
prot_corr_matrix$bin1.3 <- cor.test(prot_delta_zscores_bin1$MAF_avg,prot_delta_zscores_bin3$MAF_avg[1:1412], method = "spearman")
prot_corr_matrix$bin1.4 <- cor.test(prot_delta_zscores_bin1$MAF_avg,prot_delta_zscores_bin4$MAF_avg[1:1412], method = "spearman")
prot_corr_matrix$bin2.3 <- cor.test(prot_delta_zscores_bin2$MAF_avg,prot_delta_zscores_bin3$MAF_avg[1:2700], method = "spearman")
prot_corr_matrix$bin2.4 <- cor.test(prot_delta_zscores_bin2$MAF_avg,prot_delta_zscores_bin4$MAF_avg[1:2700], method = "spearman")
prot_corr_matrix$bin3.4 <- cor.test(prot_delta_zscores_bin3$MAF_avg,prot_delta_zscores_bin4$MAF_avg[1:4631], method = "spearman")
...
lncrna_corr_matrix$bin1.2 <- cor.test(lncrna_delta_zscores_bin1$MAF_avg,lncrna_delta_zscores_bin2$MAF_avg[1:230], method = "spearman")
lncrna_corr_matrix$bin1.3 <- cor.test(lncrna_delta_zscores_bin1$MAF_avg,lncrna_delta_zscores_bin3$MAF_avg[1:230], method = "spearman")
lncrna_corr_matrix$bin1.4 <- cor.test(lncrna_delta_zscores_bin1$MAF_avg,lncrna_delta_zscores_bin4$MAF_avg[1:230], method = "spearman")
lncrna_corr_matrix$bin2.3 <- cor.test(lncrna_delta_zscores_bin2$MAF_avg,lncrna_delta_zscores_bin3$MAF_avg[1:1033], method = "spearman")
lncrna_corr_matrix$bin2.4 <- cor.test(lncrna_delta_zscores_bin2$MAF_avg,lncrna_delta_zscores_bin4$MAF_avg[1:1033], method = "spearman")
lncrna_corr_matrix$bin3.4 <- cor.test(lncrna_delta_zscores_bin3$MAF_avg,lncrna_delta_zscores_bin4$MAF_avg[1:2441], method = "spearman")
...
sncrna_corr_matrix$bin1.2 <- cor.test(sncrna_delta_zscores_bin1$MAF_avg,sncrna_delta_zscores_bin2$MAF_avg[1:505], method = "spearman")
sncrna_corr_matrix$bin1.3 <- cor.test(sncrna_delta_zscores_bin1$MAF_avg,sncrna_delta_zscores_bin3$MAF_avg[1:505], method = "spearman")
sncrna_corr_matrix$bin1.4 <- cor.test(sncrna_delta_zscores_bin1$MAF_avg,sncrna_delta_zscores_bin4$MAF_avg[1:505], method = "spearman")
sncrna_corr_matrix$bin2.3 <- cor.test(sncrna_delta_zscores_bin2$MAF_avg,sncrna_delta_zscores_bin3$MAF_avg[1:2044], method = "spearman")
sncrna_corr_matrix$bin2.4 <- cor.test(sncrna_delta_zscores_bin2$MAF_avg,sncrna_delta_zscores_bin4$MAF_avg[1:2044], method = "spearman")
sncrna_corr_matrix$bin3.4 <- cor.test(sncrna_delta_zscores_bin3$MAF_avg,sncrna_delta_zscores_bin4$MAF_avg[1:4592], method = "spearman")
...
prot_corr_matrix$bin1.2 <- cor.test(prot_delta_zscores_bin1$GC_percentage,prot_delta_zscores_bin2$GC_percentage[1:1412], method = "spearman")
prot_corr_matrix$bin1.3 <- cor.test(prot_delta_zscores_bin1$GC_percentage,prot_delta_zscores_bin3$GC_percentage[1:1412], method = "spearman")
prot_corr_matrix$bin1.4 <- cor.test(prot_delta_zscores_bin1$GC_percentage,prot_delta_zscores_bin4$GC_percentage[1:1412], method = "spearman")
prot_corr_matrix$bin2.3 <- cor.test(prot_delta_zscores_bin2$GC_percentage,prot_delta_zscores_bin3$GC_percentage[1:2700], method = "spearman")
prot_corr_matrix$bin2.4 <- cor.test(prot_delta_zscores_bin2$GC_percentage,prot_delta_zscores_bin4$GC_percentage[1:2700], method = "spearman")
prot_corr_matrix$bin3.4 <- cor.test(prot_delta_zscores_bin3$GC_percentage,prot_delta_zscores_bin4$GC_percentage[1:4631], method = "spearman")
...
lncrna_corr_matrix$bin1.2 <- cor.test(lncrna_delta_zscores_bin1$GC_percentage,lncrna_delta_zscores_bin2$GC_percentage[1:230], method = "spearman")
lncrna_corr_matrix$bin1.3 <- cor.test(lncrna_delta_zscores_bin1$GC_percentage,lncrna_delta_zscores_bin3$GC_percentage[1:230], method = "spearman")
lncrna_corr_matrix$bin1.4 <- cor.test(lncrna_delta_zscores_bin1$GC_percentage,lncrna_delta_zscores_bin4$GC_percentage[1:230], method = "spearman")
lncrna_corr_matrix$bin2.3 <- cor.test(lncrna_delta_zscores_bin2$GC_percentage,lncrna_delta_zscores_bin3$GC_percentage[1:1033], method = "spearman")
lncrna_corr_matrix$bin2.4 <- cor.test(lncrna_delta_zscores_bin2$GC_percentage,lncrna_delta_zscores_bin4$GC_percentage[1:1033], method = "spearman")
lncrna_corr_matrix$bin3.4 <- cor.test(lncrna_delta_zscores_bin3$GC_percentage,lncrna_delta_zscores_bin4$GC_percentage[1:2441], method = "spearman")
...
sncrna_corr_matrix$bin1.2 <- cor.test(sncrna_delta_zscores_bin1$GC_percentage,sncrna_delta_zscores_bin2$GC_percentage[1:505], method = "spearman")
sncrna_corr_matrix$bin1.3 <- cor.test(sncrna_delta_zscores_bin1$GC_percentage,sncrna_delta_zscores_bin3$GC_percentage[1:505], method = "spearman")
sncrna_corr_matrix$bin1.4 <- cor.test(sncrna_delta_zscores_bin1$GC_percentage,sncrna_delta_zscores_bin4$GC_percentage[1:505], method = "spearman")
sncrna_corr_matrix$bin2.3 <- cor.test(sncrna_delta_zscores_bin2$GC_percentage,sncrna_delta_zscores_bin3$GC_percentage[1:2044], method = "spearman")
sncrna_corr_matrix$bin2.4 <- cor.test(sncrna_delta_zscores_bin2$GC_percentage,sncrna_delta_zscores_bin4$GC_percentage[1:2044], method = "spearman")
sncrna_corr_matrix$bin3.4 <- cor.test(sncrna_delta_zscores_bin3$GC_percentage,sncrna_delta_zscores_bin4$GC_percentage[1:4592], method = "spearman")
