...
lncrna_file <- "../data/datasets/histone_feature/H3K36me3/H3k36me3_lncrna_matrix.csv"
...
load_and_run <- function(histone_name, correlation_list){
  ...
  lncrna_file_p_ex1 <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_lncrna-exon1-histone-feature.csv")
  lncrna_file_n_ex1 <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_lncrna-exon1-NC-histone-feature.csv")
  lncrna_file_p_ex2 <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_lncrna-exon2-histone-feature.csv")
  lncrna_file_n_ex2 <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_lncrna-exon2-NC-histone-feature.csv")
  
  lncrna_data <- rbind(read.csv(lncrna_file_p_ex1, header = TRUE),
                       read.csv(lncrna_file_p_ex2, header = TRUE),
                       read.csv(lncrna_file_n_ex1, header = TRUE),
                       read.csv(lncrna_file_n_ex2, header = TRUE))
  #output_file <- "../data/histone_feature/lncrna_spearman_matrix.csv"
  
  sncrna_file_p <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_short-ncrna-histone-feature.csv")
  sncrna_file_n <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_short-ncrna-NC-histone-feature.csv")
  sncrna_data <- rbind(read.csv(sncrna_file_p, header = TRUE),
                       read.csv(sncrna_file_n, header = TRUE))
  #output_file <- "../data/histone_feature/protein_spearman_matrix.csv"
  
  protein_file_p_ex2 <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_protein-exon2-histone-feature.csv")
  protein_file_n_ex2 <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_protein-exon2-NC-histone-feature.csv")
  protein_file_p_ex3 <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_protein-exon3-histone-feature.csv")
  protein_file_n_ex3 <- paste0("../data/datasets/histone_feature/",histone_name,"/",histone_name,"_protein-exon3-NC-histone-feature.csv")
  protein_data <- rbind(read.csv(protein_file_p_ex2, header = TRUE),
                        read.csv(protein_file_p_ex3, header = TRUE),
                        read.csv(protein_file_n_ex2, header = TRUE),
                        read.csv(protein_file_n_ex3, header = TRUE))
  #output_file <- "../data/histone_feature/short_ncrna_spearman_matrix.csv"
  
  correlation_list[[paste0(histone_name,"_lncrna")]] <- spearman_correlation(lncrna_data)
  #correlation_matrix_combined <- do.call(rbind, correlation_list)
  
  correlation_list[[paste0(histone_name,"_sncrna")]] <- spearman_correlation(sncrna_data)
  #correlation_matrix_combined <- do.call(rbind, correlation_list)
  
  correlation_list[[paste0(histone_name,"_mrna")]] <- spearman_correlation(protein_data)
  #correlation_matrix_combined <- do.call(rbind, correlation_list)
