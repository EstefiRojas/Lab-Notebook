...
#
# Script Name: upset_formater.sh
#
# Author: Estefania Rojas
#
# Description: This script formats a particular annotation database into appropriate UpSet format to be used later in R.
#
# Input: 1. Bed file containing the annotation database to be formated. Ex. data/UpSet/chr22/gencode.v45.chr22.gentype.bed
#        2. Text file containing a list of other annotation dabases to compare the current database against. Ex. UpSetDatabaseList.txt
#        3. Name of the output bed file to save resulting formated dabase.
#           Ex. data/UpSet/chr22/chr22/gencode.v45.formatted.bed
#
############################################################################################################################
...
if [ $# -ne 3 ]; then
    echo "Usage: $0 initial_matrix.bed list_of_files.txt output_matrix_name"
    exit 1
fi
